...
// Ensure, that ClientMock does implement pkg.Client.
// If this is not the case, regenerate this file with moq.
var _ pkg.Client = &ClientMock{}

// ClientMock is a mock implementation of pkg.Client.
//
// 	func TestSomethingThatUsesClient(t *testing.T) {
//
// 		// make and configure a mocked pkg.Client
...
// 		}
//
// 		// use mockedClient in code that requires pkg.Client
